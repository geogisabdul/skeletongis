...
export function main() {
  ...
  fetch("jscroot/template/content/geojson/ch2/pwk.json")
  ...
  const polygonGeoJSONUrl = "jscroot/template/content/geojson/ch2/pwk.json";
  const lineStringGeoJSONUrl = "jscroot/template/content/geojson/ch2/pwk.json";
  const pointGeoJSONUrl = "jscroot/template/content/geojson/ch2/pwk.json";
